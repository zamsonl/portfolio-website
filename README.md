...
Personal portfolio of Zamson Lim, a Year 2 Cybersecurity student at Asia Pacific University (APU), Malaysia.
It covers my SOC, DFIR, and networking work - the projects I have built, the tools I use, and how to reach me.

## Sections

- **Projects** - featured security and software projects
- **Experience** - CTF participation and hands-on practice
- **Skills** - security, DFIR, and technical competencies
...
| Project | Focus | Link |
| --- | --- | --- |
| Real-Time SOC Visualization Suite | Wazuh, OpenSearch, JavaScript | Production deployment |
